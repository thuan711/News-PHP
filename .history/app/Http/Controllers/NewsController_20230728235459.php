...
class NewsController extends Controller
{
    ...
    public function index()
    {
        ...
        $count = $listtin->total();
        return view("admin.tin", ['listtin'=>$listtin, 'count'=>$count] );
    }
    ...
    public function store(RuleNhapTin $request)
    {
        ...
        if($request->hasFile('hinh'))
        {
            ...
            $file->move('img/upload/', $file_name);
            $tin->urlHinh = 'img/upload/'.$file_name;
        }

        $tin->save();
        $request->session()->flash('thongbao', 'Thêm tin thành công');
    ...
    public function update(Request $request, string $id)
    {
        ...
        $tin->idLT = $id_loai;
        $tin->save();
        $request->session()->flash('thongbao', 'Sửa tin thành công');
        return redirect('/admin/tin');
    }
