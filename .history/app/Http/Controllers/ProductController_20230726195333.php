...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return response()->json($arr, 400); // Trả về lỗi với mã trạng thái HTTP 400
        }
        ...
        if (!$product) {
            ...
            return response()->json($arr, 500); // Trả về lỗi với mã trạng thái HTTP 500
        }
        ...
        return response()->json($arr, 201); // Trả về thành công với mã trạng thái HTTP 201
    }
