...
class TinController extends Controller
{
    ...
    function index(Request $request){  
        ...
        $xemnhieu = DB::table('tin')->orderBy('xem','desc')->limit(3)->get();
        ...
        return view('home',['data'=>$data,'tinhot'=>$tinhot,'xemnhieu'=>$xemnhieu,'tinnb'=>$tinnb, 'loai'=>$loai,'dbl'=>$dbl,'tinmoi'=>$tinmoi]);
    }
