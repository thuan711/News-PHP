...
<section class="page-title" style="background-image: url(img/blog/about.jpg);">
      ...
      <div class="container">
        <div class="page-title__holder">
          <h1 class="page-title__title">Thông tin về AhaMag</h1>
          <p class="lead white">
            AhaMag được thành lập vào năm 2001 và chúng tôi vẫn đang kinh doanh. Còn về điều này thì sao, chúng tôi cung cấp cho bạn tạp chí tốt nhất trên thị trường.</p>
        </div>        
      </div>
    </section>
