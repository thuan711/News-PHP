                      ...
                      <tbody>
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><i class="fa-solid fa-user"></i><span class="avatar-status bg-success"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><i class="fa-solid fa-user"></i><span class="avatar-status bg-danger"></span></div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><i class="fa-solid fa-user"></i><span class="avatar-status bg-warning"></span></div>
                          </td>
                          <td>
                            <div>Quintin Ed</div>
                            <div class="small text-medium-emphasis"><span>New</span> | Registered: Jan 1, 2020</div>
                        ...
                        <tr class="align-middle">
                          <td class="text-center">
                            <div class="avatar avatar-md"><i class="fa-solid fa-user"></i><span class="avatar-status bg-secondary"></span></div>
                          </td>
                          <td>
