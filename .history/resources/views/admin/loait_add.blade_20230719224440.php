            ...
            <form class="mx-auto p-3" method="post" action="/admin/loaisp">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control">
                        @if(old('hot')==1)
                        <input name="hot" type="radio" value="1" checked> Ẩn 
                        <input name="hot" type="radio" value="0" > Hiện
                        @else
                        <input name="hot" type="radio" value="1" > Ẩn 
                        <input name="hot" type="radio" value="0" checked> Hiện
                        @endif
                    </div>
                </div>
                </div>
