            ...
            <form class="mx-auto p-3" method="post" action="/admin/loaisp">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control">
                        @if(old('hot')==1)
                        <input name="anhien" type="radio" value="1" style="margin-right: 500px;" checked> Ẩn 
                        <input name="anhien" type="radio" value="0" > Hiện
                        @else
                        <input name="anhien" type="radio" value="1" > Ẩn 
                        <input name="anhien" type="radio" value="0" checked> Hiện
                        @endif
                    </div>
