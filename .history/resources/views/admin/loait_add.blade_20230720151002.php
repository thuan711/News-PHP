            ...
            <form class="mx-auto p-3" method="post" action="/admin/loaisp">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control">
                        @if(old('hot')==1)
                        <input name="anhien" type="radio" value="1" style="height:10px;" checked> Ẩn 
                        <input name="anhien" type="radio" value="0" style="height:10px;"> Hiện
                        @else
                        <input name="anhien" type="radio" value="1" style="height:10px;"> Ẩn 
                        <input name="anhien" type="radio" value="0" style="height:10px;" checked> Hiện
                        @endif
                    </div>
