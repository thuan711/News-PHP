            ...
            <form class="mx-auto p-3" method="post" action="/admin/loaisp">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control">
                        @if(old('hot')==1)
                        <input name="anhien" type="radio" value="1" style="height:10px; alagin:left;" checked> Ẩn 
                        <input name="anhien" type="radio" value="0" style="height:10px; alagin:left;"> Hiện
                        @else
                        <input name="anhien" type="radio" value="1" style="height:10px; alagin:left;"> Ẩn 
                        <input name="anhien" type="radio" value="0" style="height:10px; alagin:left;" checked> Hiện
                        @endif
                    </div>
