            ...
            <form class="mx-auto p-3" method="post" action="/admin/loaisp">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex;">
                        @if(old('hot')==1)
                        <input name="anhien" type="radio" value="1" style="width: 30px;" checked> Ẩn 
                        <input name="anhien" type="radio" value="0" style="width: 30px;"> Hiện
                        @else
                        <input name="anhien" type="radio" value="1" style="width: 30px;"> Ẩn 
                        <input name="anhien" type="radio" value="0" checked style="width: 30px;"> Hiện
                        @endif
                    </div>
