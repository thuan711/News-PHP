		...
		<div class="container">
            <form class="mx-auto p-3" method="post" action="/admin/loaitin">
                ...
                <div class="mb-3">
                    ...
                    <input value="{{old('lang')}}" class="form-control" name="nn" >
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex; ">
                        @if(old('hot')==1)
                        <input name="anhien" type="radio" value="1" style="width: 50px; height:20px; padding:5px;" checked> Ẩn 
                        <input name="anhien" type="radio" value="0" style="width: 50px; height:20px; padding:5px;"> Hiện
                        @else
                        <input name="anhien" type="radio" value="1" style="width: 50px;height:20px; padding:5px;"> Ẩn 
                        <input name="anhien" type="radio" value="0" checked style="width: 50px; height:20px; padding:5px;"> Hiện
                        @endif
                    </div>
