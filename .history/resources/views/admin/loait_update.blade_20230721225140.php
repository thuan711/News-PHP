			...
			<form class="mx-auto p-3" method="post" action="/admin/loaitin/{{$loaitin->id}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex; ">
                        @if($loaitin->anHien==0)
                        <input name="anhien" type="radio" value="{{$loaitin->anHien}}" {{ $loaitin->anhien==0? "checked":"" }} style="width: 50px; height:20px; padding:5px;" checked> Ẩn 
                        <input name="anhien" type="radio" value="{{$loaitin->anHien}}" {{ $loaitin->anhien==1? "checked":"" }} style="width: 50px; height:20px; padding:5px;"> Hiện
                        @else
