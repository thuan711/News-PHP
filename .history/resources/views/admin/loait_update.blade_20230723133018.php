			...
			<form class="mx-auto p-3" method="post" action="/admin/loaitin/{{$loaitin->id}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex; ">         
						<input style="width: 50px; height:20px; padding:5px;" name="anhien" type="radio" value="0" {{ $loaitin->anhien==0? "checked":"" }} > Ẩn
						<input style="width: 50px; height:20px; padding:5px;" name="anhien" type="radio" value="1" {{ $loaitin->anhien==1? "checked":"" }} > Hiện
                    </div>
