...
<div class="single-product pt-5 mb-150" style="font-weight:700;">
    <div class="container">
        ...
        <table class='table table-hover table-strip table-bordered'>
            ...
            <th>ID</th> <th>Tên loại</th> <th>Thứ tự</th><th>Ngôn ngữ</th><th>Ẩn hiện</th><th class="text-end">Hành động</th>
            </tr>
            ...
            <tr><td class="align-middle"> {{$row->id}} </td>
                ...
                <td class="align-middle text-end">               
                    <form action="/admin/loaitin/{{$row->id}}" method="post">
                        ...
                        <button onclick="return confirm('Bạn muốn xóa danh mục <b>{{$row->ten}}</b>?')" class="btn btn-danger p-1" type="submit">Xóa</button>
                        @csrf  @method('DELETE')
                    </form>
                </td>
            </tr>
