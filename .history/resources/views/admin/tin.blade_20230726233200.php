            ...
            <table class='table table-hover table-strip table-bordered p-5'>
                ...
                <tr><td class="align-middle" width="120"> 
                    ...
                    <td class="align-middle" width="350"> 
                        ...
                        <p>
                            <button type="button" data-toggle="collapse" data-target="#collapseWidthExample" aria-expanded="false" aria-controls="collapseWidthExample">
