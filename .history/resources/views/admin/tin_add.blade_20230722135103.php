...
@section('noidungchinh')
    ...
    <div class="single-product pt-5 mb-150">
		<div class="container">
            <form class="mx-auto p-3" method="post" action="/admin/tin">
                ...
                <div class="mb-3">
                    <label>Tiêu đề</label> 
                    <input value="{{old('tieuDe')}}" class="form-control" rows="3" name="tieuDe" >
                </div>
                <div class="mb-3">
                    <label>Tóm tắt</label> 
                ...
                <div class="mb-3">
                    ...
                    <input value="{{old('urlHinh')}}" class="form-control" name="urlHinh">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex; ">
                        @if(old('noiBat')==1)
                        <input name="hot" type="radio" value="0" style="width: 50px; height:20px; padding:5px;" checked> Nổi bật 
                        <input name="hot" type="radio" value="1" style="width: 50px; height:20px; padding:5px;"> Bình thường
                        @else
                        <input name="hot" type="radio" value="0" style="width: 50px;height:20px; padding:5px;"> Nổi bật
                        <input name="hot" type="radio" value="1" checked style="width: 50px; height:20px; padding:5px;"> Bình thường
                        @endif
                    </div>
                </div>
                <div class="mb-3">
  ...
  var month = today.getMonth() + 1; // Tháng bắt đầu từ 0, cần +1
  var year = today.getFullYear();
  
  // Định dạng ngày theo dd/mm/yyyy
  var formattedToday = (day < 10 ? '0' : '') + day + '/' + (month < 10 ? '0' : '') + month + '/' + year;
  
  // Gán giá trị ngày hôm nay vào trường input
  document.getElementById("ngay-input").value = formattedToday;
</script>
@endsection