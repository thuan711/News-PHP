		...
		<div class="container">
			<form class="mx-auto p-3" method="post" action="/admin/tin/{{$tin->id}}">
                ...
                <div class="mb-3">
                    <label>Ẩn hiện</label> 
                    <div class="form-control" style="display:flex; ">
						<input style="width: 50px; height:20px; padding:5px;" name="anhien" type="radio" value="0" {{ $tin->anhien==1? "checked":"" }} > Ẩn
						<input style="width: 50px; height:20px; padding:5px;" name="anhien" type="radio" value="1" {{ $tin->anhien==0? "checked":"" }} > Hiện
                    </div>
                </div>
				<div class="mb-3">
