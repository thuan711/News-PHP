			...
			<form class="mx-auto p-3" method="post" action="/admin/tin/{{$tin->id}}">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-control" style="display:flex; ">
						<input style="width: 50px; height:20px; padding:5px;" name="noiBat" type="radio" value="0" {{ $tin->noiBat==0? "checked":"" }} > Nóng
						<input style="width: 50px; height:20px; padding:5px;" name="noiBat" type="radio" value="1" {{ $tin->noiBat==1? "checked":"" }} > Bình thường
                    </div>
                </div>
                <div class="mb-3">
                    <label>Ẩn hiện</label> 
