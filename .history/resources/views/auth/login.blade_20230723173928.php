...
@section('noidungchinh')
    ...
    <form class=" p-5 ml-5" style="width:60%" method="POST" action="{{ route('login') }}">
    @csrf
        <!-- Email input -->
        ...
        <div class="block">
            <label for="remember_me" class="inline-flex items-center" style="display:flex;">
                <input id="remember_me" type="checkbox" class="rounded" name="remember" style="width: 20px;">
                <span class="ml-2 text-sm text-gray-600 dark:text-gray-400 pt-2">{{ __('Nhớ mật khẩu') }}</span>
            </label>
        </div>
