    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <x-select-input id="occupation" class="block mt-1 w-full" name="occupation" :value="old('occupation')" required>
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                <label class="form-label" for="name" :value="__('Name')" >Giới tính</label>
                <x-text-input id="name" class="block mt-1 w-full" type="ridio" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control" /> Nam
                <x-text-input id="name" class="block mt-1 w-full" type="ridio" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control" /> Nữ
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
        </div>
    </div>
