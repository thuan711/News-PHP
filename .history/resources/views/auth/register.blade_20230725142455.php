    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input id="name" class="block mt-1 w-full" type="radio" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control" /> Nam
                <input id="name" class="block mt-1 w-full" type="radio" name="name" :value="old('name')" required autofocus autocomplete="name" class="form-control" /> Nữ
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
        </div>
    </div>
