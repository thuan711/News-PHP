    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input id="name" class="block mt-1 w-full" type="radio" name="name" :value="old('name')" checked autofocus autocomplete="name" class="form-control" style="width: 50px; height:20px; margin-top:2px"/> Nam
