    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input id="name" class="m-0 p-0" type="radio" name="name" :value="old('name')" checked autofocus autocomplete="name" class="form-control" style="width: 40px; height:20px; margin-top:10px;"/> Nam
