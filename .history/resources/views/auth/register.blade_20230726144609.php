    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <select id="occupation" class="block mt-1 w-full" name="nghe" :value="old('nghe')" required>
                    ...
                    <option value="developer">Công nhân</option>
                    <option value="designer">Sinh viên</option>
                    <option value="marketer">Học sinh</option>
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input id="name" type="radio" name="name" :value="old('name')"  autofocus autocomplete="name" class="form-control" style="width: 25px; height:20px; margin-left:50px;"/> Nữ
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
        </div>
    </div>
