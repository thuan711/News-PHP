    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="form-outline mb-4">
                ...
                <input id="name" type="radio" name="name" value="0" checked  class="form-control" style="width: 25px; height:20px;"/> Nam
                <input id="name" type="radio" name="name" value="1" class="form-control" style="width: 25px; height:20px; margin-left:50px;"/> Nữ
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
        </div>
    </div>
