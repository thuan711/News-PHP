    ...
    <nav class="sidenav__menu-container">
      <ul class="sidenav__menu" role="menubar">
        ...
        <li>
          ...
          <button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown"><i class="ui-arrow-down"></i></button>
          <ul class="sidenav__menu-dropdown">
            <li><a href="/about" class="sidenav__menu-link">Giới thiệu</a></li>
            <li><a href="/lienhe" class="sidenav__menu-link">Liên hệ</a></li>
        ...
        <li>
          <a href="/about" class="sidenav__menu-link">Giới thiệu</a>
        </li>

        <li>
          <a href="/lienhe" class="sidenav__menu-link">Liên hệ</a>
        </li>
      ...
      <div class="flex-parent">
        ...
        <nav class="flex-child nav__wrap d-none d-lg-block">              
          <ul class="nav__menu">
            ...
            <li>
              <a href="#" class="sidenav__menu-link">Thành viên</a>
              <button class="sidenav__menu-toggle" aria-haspopup="true" aria-label="Open dropdown"><i class="ui-arrow-down"></i></button>
                <ul class="sidenav__menu-dropdown">
                  <li><a href="lazyload.html" class="sidenav__menu-link">Đăng nhập</a></li>
                  <li><a href="404.html" class="sidenav__menu-link">Đăng ký</a></li>
                </ul>
            </li>
