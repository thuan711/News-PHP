...
Route::view('/admin','myauth.admin')->name('admin-show');
Route::view('/dangnhap','myauth.login');
Route::get('/dangnhap', [UserController::class, 'login'])->name('dangnhap');
Route::post('/dangnhap',[UserController::class,'login_']);
Route::post('/dangnhap',[UserController::class,'logout'])->name('dangxuat');
Route::view('/dangki','myauth.admin');
